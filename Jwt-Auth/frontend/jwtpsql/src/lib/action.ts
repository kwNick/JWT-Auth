...
export async function LoginAction(prevState: State, formData: FormData) {
    ...
    try {
        const response = await fetch(`http://localhost:8080/auth/login-refresh`, {
            method: 'POST',
            headers: {
...
export async function RegisterAction(prevState: State, formData: FormData) {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:8080/auth/register-refresh`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export async function LogoutAction() {
    try {
        const res = await fetch('http://localhost:8080/auth/logout-refresh', {
            method: 'POST',
            credentials: 'include'
        });
