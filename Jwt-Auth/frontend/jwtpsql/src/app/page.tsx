export default function Home() {
  return (
    <div className="p-10 flex flex-col items-center justify-center min-h-[120vh] font-[family-name:var(--font-geist-sans)] bg-white rounded-tl-2xl rounded-br-2xl shadow-md">
      <main className="w-full min-h-full flex flex-col gap-y-14 items-center sm:items-start pb-5 ">
        ...
        <div className="h-full w-full flex flex-col items-center sm:items-start justify-center">
          <p className="text-base sm:text-xl md:text-2xl text-center ">
        ...
        <div className="h-full w-full flex flex-col items-center gap-y-5  sm:items-start justify-center">
          <p className="text-base sm:text-xl md:text-2xl text-center sm:text-left">
